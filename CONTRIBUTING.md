...
Pysa [repo](https://github.com/nasa/pysa) and then use a branch from this
fork to create a pull request to the main PySA repo.

The basic process for setting up a fork is 1. Fork the PySA repo (Fork
button in upper right corner of [repo page](https://github.com/nasa/pysa)).
Forking creates a new github repo at the location
```https://github.com/USERNAME/pysa``` where ```USERNAME``` is your github
...
3. If you have drifted out of sync from the main PySA repo
...
4. Finally, push your change to your clone
    ...
    ```
5. Now when you navigate to the PySA page on github,
   [https://github.com/nasa/pysa](https://github.com/nasa/pysa) you
...
ensure that the change won't break PySA and meets our coding standards.
